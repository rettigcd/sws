...
public class TicketSession {
	...
	public async Task GetTicketsAsync(UserInfo user, int groupSize) {
		...
		// snl3(24), snl1(8)
		await Steps.____PostSessionAnalyticsEventsAsync(_context
		...
		// snl3(43), snl1(13)
		await Steps.____PostSessionAnalyticsEventsAsync(_context, Steps.BuildItemEventThumbnailSelectedEvent(_context));
		// snl3(44), snl1(14)
		await Steps.____PostSessionAnalyticsEventsAsync(_context
		...
		// snl1(17)
		await Steps.____PostSessionAnalyticsEventsAsync(_context, new ClickAnalyticsEvent("Book Event Button Event Details", new ClickAnalyticsEventProperties("Event Booking: book event button", "click", "Event")));

		// snl1(29)
		await Steps.____PostSessionAnalyticsEventsAsync(_context, new ClickAnalyticsEvent("firstName", new ClickAnalyticsEventProperties("First Name", "click", "Event")));
		// snl1(30)
		await Steps.____PostSessionAnalyticsEventsAsync(_context, new ClickAnalyticsEvent("email", new ClickAnalyticsEventProperties("Email", "click", "Event")));
		// snl1(31)
		await Steps.____PostSessionAnalyticsEventsAsync(_context, new ClickAnalyticsEvent("mobileNumber", new ClickAnalyticsEventProperties("Phone number", "click", "Event")));
		// snl1(33)
		await Steps.____PostSessionAnalyticsEventsAsync(_context, new ClickAnalyticsEvent("firstName", new ClickAnalyticsEventProperties("First Name", "click", "Event")));
		...
		// snl1(36)
		await Steps.____PostSessionAnalyticsEventsAsync(_context, new ClickAnalyticsEvent("Complete Button Customer Details", new ClickAnalyticsEventProperties("Event Booking: customer details complete button", "click", "Event")));
		// snl1(37)
	...
	public async Task GetTicketsAsync_Fast(UserInfo user, int groupSize) {
		_context.SeriesId = "UZJLSRJUNZC";
